<?php
//bu sayfayý sadece siteye giriþ yapabilen kiþiler görmeli
include("../../../../../pfi-yonetici-yetki.php");
...
$opts = array(
	'root'            => "../dosyalar/" ,                       // path to root directory
	'URL'             =>  "http://" . $dizin . "/WEB/2012/GYSD/gysd/gysd/pfi-depo/", // root directory URL
	'rootAlias'       => $kullanici,       // display this instead of root directory name
